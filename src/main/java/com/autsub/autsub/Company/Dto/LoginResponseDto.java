...
public class LoginResponseDto {
    ...
    public LoginResponseDto(@NotBlank @NotNull String name, @NotBlank @NotNull String email,
            @NotBlank @NotNull String address, @NotBlank @NotNull String industry,
            @NotBlank @NotNull String commercial_Registration_Number, @NotNull boolean active,
